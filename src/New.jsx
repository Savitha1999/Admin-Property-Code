...
//         <Row className="g-0">
//           <Col md={3}>
//             <Card.Img variant="left" src={placement.photo || 'https://via.placeholder.com/150'} alt={placement.name} />
//           </Col>
//           <Col md={7}>
//             <Card.Body>
...
//         <Row className="g-0">
//           <Col md={3}>
//             <Card.Img variant="left" src={testimonial.photo || 'https://via.placeholder.com/150'} alt={testimonial.name} />
//           </Col>
//           <Col md={7}>
//             <Card.Body>
//               <Card.Title>{testimonial.name}</Card.Title>
//               <p><strong>Message:</strong> {testimonial.message}</p>
//               <p><strong>Rating:</strong> {testimonial.starRating}</p>
//               <p><strong>Professional:</strong> {testimonial.professional}</p>
//             </Card.Body>
//           </Col>
//           <Col md={2} className="d-flex align-items-center justify-content-center">
//             <Button variant="success">Approve</Button>
...
//     <Container>
//       <h2>Profile Cards</h2>
//       <Nav variant="tabs" activeKey={category} onSelect={(selectedKey) => setCategory(selectedKey)}>
//         <Nav.Item>
